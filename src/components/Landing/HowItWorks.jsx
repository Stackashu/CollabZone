  ...
  return (
    <div className={`${style.guide}`}>
      ...
      <div className={`${style.video}`}>
        ...
        <img className={`${style.play}`} src={playbutton} alt={playbutton} />

        <img src={guidevideo} alt="video"></img>
        <div className={`${style.description}`}>
          Welcome to CollabZone! This video tutorial is tailored for new users,
          guiding you through the platform. In just a few minutes, learn how to
          set up your profile, connect with entrepreneurs, and access key
          features to enhance your collaboration experience.
        </div>
      </div>
      </div>
